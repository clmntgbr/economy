...
class JWTTokenAuthenticator extends \Lexik\Bundle\JWTAuthenticationBundle\Security\Guard\JWTTokenAuthenticator
{
    ...
    public function getCredentials(Request $request)
    {
        ...
        $token = $this->tokenRepository->findOneBy(['userId' => $user->getId()]);
