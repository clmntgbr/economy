...
final class Version20201017080106 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE gas_station_service DROP FOREIGN KEY FK_FD56A06BED5CA9E6');
        $this->addSql('ALTER TABLE gas_price DROP FOREIGN KEY FK_EEF8FDB621BDB235');
        $this->addSql('ALTER TABLE gas_station_service DROP FOREIGN KEY FK_FD56A06B21BDB235');
