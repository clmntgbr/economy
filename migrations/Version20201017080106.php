...
final class Version20201017080106 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE gas_price (id INT AUTO_INCREMENT NOT NULL, type_id INT DEFAULT NULL, station_id INT DEFAULT NULL, created_by INT DEFAULT NULL, value DOUBLE PRECISION NOT NULL, date DATETIME NOT NULL, date_timestanp INT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, INDEX IDX_EEF8FDB6C54C8C93 (type_id), INDEX IDX_EEF8FDB621BDB235 (station_id), INDEX IDX_EEF8FDB6DE12AB56 (created_by), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE gas_station_services (service_id INT NOT NULL, station_id INT NOT NULL, INDEX IDX_FD56A06BED5CA9E6 (service_id), INDEX IDX_FD56A06B21BDB235 (station_id), PRIMARY KEY(service_id, station_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
